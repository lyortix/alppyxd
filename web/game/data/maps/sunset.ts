  ...
  npcs: [
    {
      ...
      wander: 40,
      lines: [
        "evenin'. the light's always best about now, isn't it?",
        "been here longer than the lamps have. never gets old.",
        "if you're new — the café pours a good cup. tell 'em I sent you.",
        "sit on a bench a while. the square rewards the unhurried.",
      ],
    },
    {
      id: "cat",
      ...
      y: 880,
      wander: 120,
      lines: ["mrrp.", "*blinks slowly at you*", "prrrrr…", "*flicks tail and wanders off*"],
    },
  ],
  ambience: "sunset",
};
